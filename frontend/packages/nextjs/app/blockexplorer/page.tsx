...
const BotCreator: NextPage = () => {
  ...
  return (
    <div className="container mx-auto my-10">
      <h1 className="text-4xl font-bold mb-8 text-center">Create Your Bot</h1>
      
      {storedBots.length > 0 && !isCreated && (
        <div className="mb-12">
          <h2 className="text-3xl font-bold mb-6 text-center">Your Bot Collection</h2>
            ...
            {storedBots.map((storedBot) => (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3 className="text-2xl font-bold text-primary mb-1">{storedBot.name}</h3>
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <p className="font-bold text-lg text-gray-100">{calculateMBTI(storedBot)}</p>
        ...
        <div className="max-w-md mx-auto p-6 border rounded-lg">
          ...
          <div className="flex gap-2 mt-4">
            <button
              ...
              className="flex-1 bg-secondary text-white py-2 rounded-lg hover:bg-secondary-focus"
            >
              Create Another Bot
            </button>
            <button
              onClick={() => window.location.reload()}
              className="flex-1 bg-primary text-white py-2 rounded-lg hover:bg-primary-focus"
            >
              View All Bots
            </button>
          </div>
